...
class ListaRecursos {
    ...
    companion object {
        ...
        const val texto_Introduccion =
            "Hola! Nosotros somos Patxi y Miren, los protagonistas y los guías " +
        ...
        const val texto_PuertaSanJuan =
            "En el siglo XIV, Bermeo estaba rodeado de una gran muralla. Esa muralla " +
        ...
        const val texto_Badatoz =
            "Bermeo desde siempre ha sido un pueblo pesquero, por ello los bermeanos " +
        ...
        const val texto_FeriaPescado =
            "La Arrain Azoka es la feria del pescado de Bermeo. Es una de las ferias y eventos " +
        ...
        const val texto_Olatua =
            "Esta escultura fue creada por el artista Néstor Basterretxea y está situada en el " +
        ...
        const val texto_Xixili =
            "Érase una vez un pescador que mientras trabajaba, encontró a una lamia " +
                    "que estaba herida.\n\n" +
        ...
        const val texto_Izaro =
            "Hoy en día, la isla de Izaro pertenece a Bermeo, aunque esto no siempre fue así. " +
        ...
        const val texto_Gaztelugatxe =
            "San Juan de Gaztelugatxe es una isla con forma de cono que está situada " +
